...
class Eyeball(pg.sprite.Sprite):
    def __init__(self, x, y, platform_group, scroll):
        super().__init__()
        self.screen = pg.display.get_surface()
        
        # Load sprite image
        self.image = pg.image.load("assets/enemies/eyeball/eyeball.png").convert_alpha()
        ...
        self.hit_sound = pg.mixer.Sound("assets/soundeffects/eyeballhit.mp3")
